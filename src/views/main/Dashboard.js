...
import "assets/css/views/Dashboard.scss"
import DaTokenTable from "components/Navbars/DaTokenTable.js"
import DaNftTable from "components/Navbars/DaNftTable.js"
...
import DashboardPng from "assets/img/SolviewIcons/Dashboard/Dashboard_blue.svg"
...
function Dashboard() {
    ...
    const netWorth = useSelector((store) => store.provider.networth);
    return (
        <>
            <Container
                maxWidth={false}
            ...
            >
                <Grid container id="dashboardLogo">
                    <Grid className="dashImgChip"><img src={DashboardPng}></img></Grid>&nbsp;&nbsp;
                    <Grid id="dashboardLetter">DashBoard</Grid>
                </Grid>
